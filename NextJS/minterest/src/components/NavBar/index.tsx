          ...
          <Link href={"/"}>
            <div className={styles.navbarLeft}>
              <Image
                ...
                alt="pinterestLogo"
              />
              <p className={styles.navbarBrand}>Minterest</p>
            </div>
          </Link>

          <div className={styles.navbarRight}>
            <div>
              <ul className={styles.navbarTextList}>
                <li>
                  <Link href={"/about"}>Hakkında</Link>
                </li>
                <li>
                  <Link href={"/business"}>İş Dünyası</Link>
                </li>
                <li>
            ...
            <ul className={styles.navbarButtonList}>
              <li>
                <Link href={"/login"} type="button" className={styles.btnLogin}>
                  <div className={styles.loginInner}>
                    <div className={styles.loginInnerText}>Oturum Aç</div>
                  </div>
                </Link>
              </li>
              <li>
                ...
                >
                  <div className={styles.registerInner}>
                    <div className={styles.registerInnerText}>Kaydol</div>
                  </div>
                </Link>
              </li>
            </ul>
